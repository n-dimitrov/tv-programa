...
**Data source**: `aisdlc/meta/run-log.jsonl` — fields `outcome` and `task_summary`.

**Collection**: Automated, computed by `aisdlc/hooks/compute-metrics.sh`

**Frequency**: Weekly (output: `aisdlc/meta/metrics-snapshots/YYYY-MM-DD.json`, field `pull_readiness_proxy`)
...
**Data source**: `aisdlc/meta/run-log.jsonl` — field `outcome`.

**Collection**: Automated, computed by `aisdlc/hooks/compute-metrics.sh`

**Frequency**: Weekly (output: `aisdlc/meta/metrics-snapshots/YYYY-MM-DD.json`, field `wip_stability`)
