...
**Data source**: `aisdlc/meta/run-log.jsonl` — field `skill`.

**Collection**: Automated, computed by `aisdlc/hooks/compute-metrics.sh`

**Frequency**: Weekly (output: `aisdlc/meta/metrics-snapshots/YYYY-MM-DD.json`, field `skill_reuse_rate`)
...
**Frequency**: Weekly (output: `aisdlc/meta/metrics-snapshots/YYYY-MM-DD.json`, field `wip_stability` as proxy)
