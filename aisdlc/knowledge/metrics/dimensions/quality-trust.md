...
**Data source**: `aisdlc/meta/run-log.jsonl` — fields `outcome`, `task_summary`, `timestamp`.

**Collection**: Automated, computed by `aisdlc/hooks/compute-metrics.sh`

**Frequency**: Weekly (output: `aisdlc/meta/metrics-snapshots/YYYY-MM-DD.json`, field `ai_acceptance_rate`)
...
**Data source**: `aisdlc/meta/run-log.jsonl` — fields `task_summary`, `timestamp`, `outcome`.

**Collection**: Automated, computed by `aisdlc/hooks/compute-metrics.sh`

**Frequency**: Weekly (output: `aisdlc/meta/metrics-snapshots/YYYY-MM-DD.json`, field `rework_rate`)
