...
10. Frontend uses `window.location.pathname` for routing — no React Router library; just conditional rendering in `App.tsx`
...
| Existing architectural decisions | `aisdlc/knowledge/architecture/adr/README.md` |
| Component details | `aisdlc/knowledge/components/README.md` |
| Coding patterns | `aisdlc/knowledge/patterns/coding-patterns.md` |
| Domain model and entities | `aisdlc/knowledge/domain.md` |
...
./scripts/generate-monthly-summary.sh        # Generate Oscar monthly summary
```
