...
description: "Implement backend features — APIs, services, storage, scraping, Oscar matching, background tasks — following established patterns. Use when a user wants to build or fix something on the server side (Python/FastAPI). Loads backend-specific patterns before writing any code."
---
