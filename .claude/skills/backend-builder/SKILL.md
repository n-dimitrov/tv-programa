...
description: "Implement backend features — APIs, services, data processing, scraping, Oscar matching — following established patterns. Use when a user wants to build or fix something on the server side. Loads backend-specific patterns before writing any code."
---
