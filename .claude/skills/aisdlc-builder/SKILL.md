---
name: aisdlc-builder
description: "DO NOT INVOKE DIRECTLY. This is a template — copy and rename per builder role (e.g. backend-builder, frontend-builder). If you need to build something, use a role-specific builder like /backend-builder or /frontend-builder. If no role-specific builder exists yet, run /aisdlc-onboard to create them."
---
