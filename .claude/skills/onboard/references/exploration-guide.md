...
Heuristics for reading existing codebases efficiently. Use during Phase 2 (Domain Deep-Dives) of the onboard discovery process.
...
For each major component identified, generate `docs/components/[name].md` with this structure:
