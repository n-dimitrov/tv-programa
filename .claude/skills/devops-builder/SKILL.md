---
name: devops-builder
description: "Implement infrastructure and deployment features — Dockerfile, Cloud Run config, GCS setup, CI/CD scripts, monitoring — following established patterns. Use when a user wants to build or fix something in the deployment or infrastructure layer. Loads devops-specific patterns before writing any code."
---
