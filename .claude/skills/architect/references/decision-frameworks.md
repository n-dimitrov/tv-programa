...
Structured approaches for architectural decisions where options are genuinely close or the trade-offs are hard to articulate. Use these when Step 3 of the architect workflow isn't yielding clear differentiation.
...
## Notes on using frameworks in the architect workflow
