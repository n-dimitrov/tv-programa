...
description: "Implement frontend features — React components, state management, styling, API integration — following established patterns. Use when a user wants to build or fix something in the UI layer (React 19/TypeScript). Loads frontend-specific patterns before writing any code."
---
